...
const requisito13 = '13 - Renderize o componente `<Rating />` dentro de `<MovieCard />`';
describe.skip(requisito13, () => {
  let wrapper;
...
const req14 = '14 - Passe como prop para o componente `<Rating/>` o atributo `rating`';
describe.skip(req14, () => {
  let wrapper;
  const movie = movies[0];
